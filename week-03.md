...
| 질문 | 후보 A | 후보 B | 후보 C |
|---|---|---|---|
| 이 안에 **누구의 정보**가 들어가는가<br>그 사람이 우리 사용자와 같은 사람인가 | 야간 숏폼 콘테츠를 이용하는 사람| 리뷰를 확인하지 않고 소비하는 사람 | 교내에서 차량을 이용하는 사람 |
| 쓰고 싶어도 **못 쓰는 사람**은 누구인가 | 숏폼 콘텐츠를 이용안하는 사람 | 소비할때 리뷰를 꼼꼼히 확인하는 삶 | 자차가 없는 사람 |
